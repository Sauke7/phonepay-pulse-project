...
import json
import os
path="C:/phonepayproject/pulse/data/map/transaction/hover/country/india/state/"
...
values = [tuple(x) for x in map_trans.to_numpy()]

mycursor.executemany(query, values)
mydb.commit()   
print("✅ Data inserted successfully into map_trans table")
query = """
